...
static char srgb_ce_param_24[] = {0x32,0x06};
static char srgb_ce_param_25[] = {0x33,0x00};
static char srgb_ce_param_26[] = {0x34,0x00};
static char srgb_ce_param_27[] = {0x35,0x00};
...
static char srgb_ce_param_34[] = {0x3F,0x00};
static char srgb_ce_param_35[] = {0x40,0x00};
static char srgb_ce_param_36[] = {0x41,0x04};
static char srgb_ce_param_37[] = {0x42,0x08};
static char srgb_ce_param_38[] = {0x43,0x0C};
static char srgb_ce_param_39[] = {0x44,0x10};
static char srgb_ce_param_40[] = {0x45,0x10};
static char srgb_ce_param_41[] = {0x46,0x0C};
static char srgb_ce_param_42[] = {0x47,0x0C};
static char srgb_ce_param_43[] = {0x48,0x0C};
static char srgb_ce_param_44[] = {0x49,0x0C};
static char srgb_ce_param_45[] = {0x4A,0x0C};
static char srgb_ce_param_46[] = {0x4B,0x0C};
static char srgb_ce_param_47[] = {0x4C,0x0C};
...
static char srgb_ce_param_52[] = {0x55,0x00};
...
static char srgb_ce_param_57[] = {0xEB,0xD8};
static char srgb_ce_param_58[] = {0xEC,0x13};
static char srgb_ce_param_59[] = {0xED,0x3B};
static char srgb_ce_param_60[] = {0xEE,0x13};
static char srgb_ce_param_61[] = {0xEF,0xB5};
static char srgb_ce_param_62[] = {0xF0,0x30};
static char srgb_ce_param_63[] = {0xF1,0x0D};
static char srgb_ce_param_64[] = {0xF2,0x15};
static char srgb_ce_param_65[] = {0xF3,0xF5};
static char srgb_ce_param_66[] = {0xF4,0x08};
static char srgb_ce_param_67[] = {0xF5,0x80};
...
static u32 acm_lut_hue_table[] = {
	...
	0x000e, 0x000f, 0x000f, 0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018, 0x0019, 0x001a, 0x001b, 0x001c, 
	0x001d, 0x001e, 0x001f, 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002a, 0x002b, 0x002c, 
	0x002d, 0x002e, 0x002f, 0x0030, 0x0031, 0x0032, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003a, 0x003b, 0x003c, 0x003d, 
	0x003e, 0x003f, 0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x004a, 0x004b, 0x004c, 0x004d, 0x004e, 
	...
	0x0332, 0x0334, 0x0335, 0x0336, 0x0337, 0x0338, 0x0339, 0x033a, 0x033b, 0x033c, 0x033d, 0x033e, 0x033f, 0x0340, 0x0341, 0x0342, 
	0x0343, 0x0344, 0x0345, 0x0346, 0x0347, 0x0348, 0x034a, 0x034b, 0x034c, 0x034d, 0x034e, 0x034f, 0x0350, 0x0351, 0x0352, 0x0353, 
	0x0354, 0x0356, 0x0357, 0x0358, 0x0359, 0x035a, 0x035b, 0x035c, 0x035d, 0x035e, 0x035f, 0x0361, 0x0362, 0x0363, 0x0364, 0x0365, 
	0x0366, 0x0367, 0x0368, 0x0369, 0x036a, 0x036b, 0x036d, 0x036e, 0x036f, 0x0370, 0x0371, 0x0372, 0x0373, 0x0374, 0x0375, 0x0376, 
	0x0378, 0x0379, 0x037a, 0x037b, 0x037c, 0x037d, 0x037e, 0x037f, 0x0380, 0x0381, 0x0382, 0x0384, 0x0385, 0x0386, 0x0387, 0x0388, 
	0x0389, 0x038a, 0x038b, 0x038c, 0x038d, 0x038e, 0x038f, 0x0391, 0x0392, 0x0393, 0x0394, 0x0395, 0x0396, 0x0397, 0x0398, 0x0399, 
	0x039a, 0x039b, 0x039c, 0x039d, 0x039f, 0x03a0, 0x03a1, 0x03a2, 0x03a3, 0x03a4, 0x03a5, 0x03a6, 0x03a7, 0x03a8, 0x03a9, 0x03aa, 
	0x03ac, 0x03ad, 0x03ae, 0x03af, 0x03b0, 0x03b1, 0x03b2, 0x03b3, 0x03b4, 0x03b5, 0x03b6, 0x03b7, 0x03b8, 0x03ba, 0x03bb, 0x03bc, 
	0x03bd, 0x03be, 0x03bf, 0x03c0, 0x03c1, 0x03c2, 0x03c3, 0x03c4, 0x03c5, 0x03c6, 0x03c8, 0x03c9, 0x03ca, 0x03cb, 0x03cc, 0x03cd, 
	0x03ce, 0x03cf, 0x03d0, 0x03d1, 0x03d2, 0x03d3, 0x03d3, 0x03d4, 0x03d5, 0x03d6, 0x03d7, 0x03d8, 0x03d9, 0x03da, 0x03db, 0x03dc, 
	0x03dc, 0x03dd, 0x03de, 0x03df, 0x03e0, 0x03e1, 0x03e2, 0x03e3, 0x03e3, 0x03e4, 0x03e5, 0x03e6, 0x03e6, 0x03e7, 0x03e8, 0x03e9, 
	0x03ea, 0x03ea, 0x03eb, 0x03ec, 0x03ed, 0x03ed, 0x03ee, 0x03ef, 0x03f0, 0x03f0, 0x03f1, 0x03f2, 0x03f3, 0x03f3, 0x03f4, 0x03f5, 
	0x03f5, 0x03f6, 0x03f7, 0x03f7, 0x03f8, 0x03f9, 0x03f9, 0x03fa, 0x03fb, 0x03fb, 0x03fc, 0x03fd, 0x03fd, 0x03fe, 0x03ff, 0x03ff, 
};
